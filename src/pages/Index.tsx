...
const slides = [
  ...
  },
  {
    ...
    tag: "03 / ТЕХНОЛОГИЯ",
    title: "Как ИИ строит",
    subtitle: "твой учебный план",
    description:
      "ИИ изучает интересы ученика и формирует персональный план на весь учебный год — с чёткими целями и направлениями, которые по-настоящему увлекают.",
    accent: "Не шаблон, а маршрут — созданный лично для тебя.",
    visual: "tech",
    steps: [
      { num: "01", title: "Интересы", desc: "ИИ выясняет, что увлекает ученика: наука, творчество, технологии или спорт" },
      { num: "02", title: "Цели года", desc: "Формирует список знаний и навыков, которые нужно освоить к концу учебного года" },
      { num: "03", title: "Направления", desc: "Подбирает темы и предметы, которые совпадают с интересами ученика" },
      { num: "04", title: "Готовый план", desc: "Выдаёт структурированный учебный маршрут на год — понятный и мотивирующий" },
    ],
  },
  {
    id: 4,
